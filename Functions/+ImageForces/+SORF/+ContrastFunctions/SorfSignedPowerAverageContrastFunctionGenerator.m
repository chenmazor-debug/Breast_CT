function contrastFunction = SorfSignedPowerAverageContrastFunctionGenerator(powerNumber ,contrastKUserControlFuncs )
...
%   Detailed explanation goes here
    ...
    function contrast = ContrastFunction(contrastImage, sorfResponses)
        ...
        for k=1:numOfResponses
            ...
            localContrastK = sign(sorfResponseK).*(sorfResponseK.^powerNumber);
        ...
        contrast = (1/numOfResponses)*(contrast.^(1/powerNumber));
    end
