function multiScaleMasks = CreateSorfContrastMultiScaleMasks(scales)
    %check inputs
...
%         surroundArea = circshift(surroundArea,[1,surroundDiameter]);
%         
%         ShiftMaskPixels = centerDiameter;  
        ...
        multiScaleMasks{i} = ImageForces.SORF.CreateSorfMask(centerArea, centerGaussianFunction,surroundArea,surroundGaussianFunction,ShiftMaskPixels);
    end
end