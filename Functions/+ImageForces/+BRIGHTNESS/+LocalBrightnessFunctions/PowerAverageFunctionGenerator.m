function localBrightnessFunction = PowerAverageFunctionGenerator(powerNumber ,brightnessKUserControlFuncs )
...
%   Detailed explanation goes here
    ...
    function brightness = BrightnessFunction(~, brightnessResponses)
        ...
        for k=1:numOfResponses
            ...
            localBrightnessK = (brightnessResponseK.^powerNumber)/numOfResponses;
        ...
        brightness = (brightness.^(1/powerNumber));
    end
